...
const PaymentsComponent = () => {
        ...
        const fetchAddress = async () => {
            ...
            if (userId) {
                try {
                    ...
                    // const response = await axios.get(`http://localhost:5050/address/get/${userId}`);
                    // console.log("response ", response);
                    // console.log("response of addresses",response.data.userAddress)
                } catch (error) {
    ...
    const sendPushNotification = async () => { 
        try {
        //   const response = await fetch('http://localhost:5050/send-notification', {
        //     method: 'POST',
                    ...
                    {(paymentId !== null && razorpayOrderId !== null ) ?
                        <>
                            ...
                            <Controls.Grid item sx={{ display: "block", alignItems: "center", textAlign: "center", }} mt={4}>
                                ...
                                <Controls.Box component="img" src="https://uxwing.com/wp-content/themes/uxwing/download/e-commerce-currency-shopping/order-placed-purchased-icon.svg" width="100%" height="100%" sx={{ width: "350px", height: "250px", }} />
                                <Controls.Typography variant='h4'> order palced successfully</Controls.Typography>
                                <Controls.Typography variant='h6'>Order_Id:{razorpayOrderId}</Controls.Typography>
                            </Controls.Grid>
                        </> :

     ...
     <Controls.Grid container justifyContent="center">
        ...
        <Controls.Grid item  xs={12}sx={{display:{xs:"block",sm:"flex"},justifyContent:{xs:"center",sm:"space-between"},alignItems:"center"}}  mt={1}gap={3}>
            ...
            <Controls.Grid item xs={12} sm={6}>
                <Controls.Box component="img" src="https://img.freepik.com/premium-photo/showcase-farmers-harvesting-organic-produce-healthy-sustainable-lifestyle_1042793-10614.jpg?semt=ais_hybrid" sx={{width:{xs:"100%",sm:"300px",md:"400px",lg:"550px"},height:{xs:"100%",sm:"300px",md:"320px",lg:"100%"},borderTopLeftRadius:"80px",borderBottomRightRadius:"80px"}}/>
            </Controls.Grid>
        ...
        <Controls.Grid item  xs={12}sx={{display:{xs:"block",sm:"flex"},justifyContent:{xs:"center",sm:"space-between"},alignItems:"center"}}  mt={1}gap={3}>
            ...
            <Controls.Grid item xs={12} sm={6} sx={{textAlign:"right"}}>
                <Controls.Box component="img" src="https://t4.ftcdn.net/jpg/10/12/70/71/360_F_1012707179_ol5IuFX1O1h7NQfiLsNj3KWjzJRK4LkL.jpg" sx={{width:{xs:"100%",sm:"300px",md:"400px",lg:"550px"},height:{xs:"100%",sm:"300px",md:"320px",lg:"100%"},borderTopLeftRadius:"80px",borderBottomRightRadius:"80px"}}/>
            </Controls.Grid>
        </Controls.Grid>
        </Controls.Grid>
        </Controls.Grid>

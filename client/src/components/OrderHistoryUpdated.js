...
const OrderHistoryUpdated = () => {
    ...
    // const [cancelledDate , seCancelledDate] = useState(null)
    // const [cancelledReason , seCancelledReason] = useState(null)
    // const [cancelledStatus , seCancelledStatus] = useState(null)

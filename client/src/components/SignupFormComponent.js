...
/>*/}
      ...
      height: "auto",}}>
          <Controls.Grid item xs={11} sm={8} md={6} sx={{    justifyContent: "center",margin:"auto",alignItems:"center",}}>
              ...
              <Controls.Grid item xs={12} sx={{ }}  >
                ...
                >
                  {({ errors, touched, isSubmitting, }) => (
                    <Form>
                      <Controls.Grid container spacing={2} item sx={{ height: "auto",paddingY:2 ,alignItems:"center"}}>

                        <Controls.Grid item sx={{ textAlign: "center", justifyContent: "center" }} my={2}>
                          <Controls.Typography
                            variant='text1'
